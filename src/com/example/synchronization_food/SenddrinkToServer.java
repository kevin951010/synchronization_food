...
public class SenddrinkToServer {
	//private static String url="http://10.0.2.2:8080/drink/servletdrink";
	//private static String url="http://115.159.88.108:8080/drink/servletdrink";
	private static String url="http://118.89.45.193:8080/drink/servletdrink";
    public static final int SEND_SUCCESS=0x123;  
    public static final int SEND_FAIL=0x124;  
    private Handler handler;  
    public  SenddrinkToServer(Handler handler) {  
     ...
     * @param pwd  密码 
     */  
    public void SendDataToServer(String tablenumber,String drink,String cost) {  
