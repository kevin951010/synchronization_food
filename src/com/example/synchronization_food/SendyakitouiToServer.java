...
public class SendyakitouiToServer {
	//private static String url="http://10.0.2.2:8080/yakitoui/servletyakitoui";
	//private static String url="http://115.159.88.108:8080/yakitoui/servletyakitoui";
	private static String url="http://118.89.45.193:8080/yakitoui/servletyakitoui";
    public static final int SEND_SUCCESS=0x123;  
    public static final int SEND_FAIL=0x124;  
    private Handler handler;  
    public  SendyakitouiToServer(Handler handler) {  
     ...
     * @param pwd  密码 
     */  
    public void SendDataToServer(String tablenumber,String yakitoui,String cost) {  
        // TODO Auto-generated method stub  
        Log.d("tablenumber",tablenumber);
        Log.d("yakioui",yakitoui);
        Log.d("cost",cost);
