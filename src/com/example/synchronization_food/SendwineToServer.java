...
public class SendwineToServer {
	//private static String url="http://10.0.2.2:8080/wine/servletwine";
	//private static String url="http://115.159.88.108:8080/wine/servletwine";
	private static String url="http://118.89.45.193:8080/wine/servletwine";
    public static final int SEND_SUCCESS=0x123;  
    public static final int SEND_FAIL=0x124;  
    private Handler handler;  
    public  SendwineToServer(Handler handler) {  
     ...
     * @param pwd  密码 
     */  
    public void SendDataToServer(String tablenumber,String wine,String cost) {  
