...
public class RecyclecostFromServer implements Callable{
	//private String url="http://10.0.2.2:8080/cost/servletcost";
	//private String url="http://115.159.88.108:8080/cost/servletcost"; 
	private String url="http://118.89.45.193:8080/cost/servletcost";
    ...
    String str="";
    String time="";
    public RecyclecostFromServer(Handler handler,String time) {   
